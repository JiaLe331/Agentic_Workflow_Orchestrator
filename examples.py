# python3 main.py --query "replace the name of li jie to li jia"

# python3 main.py --query "replace the name of li jie to li jia, and then update his nationality to china"
